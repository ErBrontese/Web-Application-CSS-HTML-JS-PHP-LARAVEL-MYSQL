...
class ProductController extends Controller
{
    ...
    public function help_show()
    {
        ...
        $valuePrice = 0;
        $valuePrice = request('valueSearchPrice'); 
        if ($valuePrice == 0) {
            $valuePrice = 1;
        }

        $filterValue = request('nameSearch');
        ...
        $valuePriceRange1 = request('valueSearchPrice1'); 
        $valuePriceRange2 = request('valueSearchPrice2'); 
        ...
        $typeFilter = request('filterPrice');
        $empty = 0;
