...
class ClientController extends Controller
{
    ...
    public function login()
    {
        $countProdotti="";
        $idCart="";
        return view('clients.login', compact('countProdotti','idCart'));
    }
    ...
    public function edit(Client $client)
    {
        ...
        $countProdotti="";
        $idCart="";
        return view('clients.edit', compact('client','countProdotti','idCart','decrypt'));
    }
