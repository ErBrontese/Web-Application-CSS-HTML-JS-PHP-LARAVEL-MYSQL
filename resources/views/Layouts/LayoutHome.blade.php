...
<body class="@yield('classe')">
 ...
 $lock=0;
 if($success == 1){
    echo"<script>localStorage.setItem('key2', '$id');</script>";
 }
    ...
    <div class="pageWrapper">
        ...
        <div class="search">
            <div class="search__form">
                <form class="search-bar__form" action="/products/help_show" method="post">
                    ...
                    <input class="search__input" type="search" name="value" id="value" value=""
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <div class="wrapQtyBtn">
                                                <div class="qtyField">
                                                    <span class="label">Quantità:{{$prod->quantità}}</span>
                                                </div>
                                            </div>
                                            <div class="priceRow">
                                                <div class="product-price">
                                                    <span class="money">Prezzo:{{$prod->prezzoProdotto}}€</span>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <div class="total">
                                    ...
                                    <div class="total-in">
                                        ...
                                        <span class="label">Cart Subtotal:</span><span class="product-price">
                                            ...
                                            @endif
                                        @else
                                        <span class="label">Nessun elemento nel carrello</span>
                                        @endif
                                    </div>
                                  
                                    @if($countProdotti!=0)
                                    <div class="buttonSet text-center">
                                        <a href="/cart_products/{{$idCart}}" class="btn btn-secondary btn--small">Mostra
                                            carrello</a>
        ...
        <nav class="belowlogo" id="AccessibleNav">
            <ul id="siteNav" class="site-nav medium center hidearrow">
                ...
                <li class="lvl1 parent megamenu"><a href="/about">About <i class="anm anm-angle-down-l"></i></a></li>
