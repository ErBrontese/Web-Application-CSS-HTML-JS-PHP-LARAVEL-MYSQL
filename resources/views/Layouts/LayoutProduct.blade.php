    ...
    <div class="pageWrapper">
        ...
        <div class="search">
            <div class="search__form">
                <form class="search-bar__form" action="/products/help_show" method="post">
                    @csrf

                    <input class="search__input" type="search" name="value" id="search" value=""
        ...
        <div class="top-header home8-jewellery-top">
            ...
            <div class="alert" style="margin-top:-1%;">
                ...
                console.log("Success");
                var x = document.getElementsByClassName("alert")[0];
                x.setAttribute("id", "msgStatusNot");
                </script>
                @endif

                <div style="text-align: center;"><?php echo $msgStatus ?></div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-10 col-sm-8 col-md-5 col-lg-4">
                        ...
                        <p class="phone-no"><i class="anm anm-phone-s">&nbsp;</i>329 1381553</p>
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4 d-none d-lg-none d-md-block d-lg-block">
                        <div class="text-center">
                            <p class="top-header_middle-text"> Spedizione espressa in tutta Italia </p>
                        </div>
                    </div>
                    <div class="col-2 col-sm-4 col-md-3 col-lg-4 text-right">
                        ...
                        <ul class="customer-links list-inline">
                            ...
                            <li><a id="logout" style="display:none;" href="logout" onclick="logout()">Logout</a></li>
                            <li><a id="createAccount" href="/clients/create">Crea Account</a></li>
                            <li><a id="account" style="display:none;" href="/account">Account</a></li>
        ...
        <div class="header-wrap animated d-flex">
            <div class="container-fluid">
                <div class="row align-items-center" style="@yield('style')">
                    <!--Desktop Logo-->
                    <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                        <a href="/" style="text-decoration:none;">
                            <img class="logoImg" src="/images/logo.png" alt="Belle Multipurpose Html Template"
                                title="Belle Multipurpose Html Template" />
                            <p style="display:inline;">Siciliy Market</p>
                        </a>
                    </div>
                    <!--End Desktop Logo-->
                    <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                        ...
                        <nav class="grid__item" id="AccessibleNav">
                            ...
                            <ul id="siteNav" class="site-nav medium center hidearrow">
                                ...
                                <li class="lvl1"><a href="/about"><b>About</b></a></li>
                            </ul>
                        </nav>
                        <!--End Desktop Menu-->
                    </div>
                        ...
                        <div class="site-cart">
                            <a href="#;" class="site-header__cart" title="Cart">
                                ...
                                <span id="CartCount" class="site-header__cart-count"
                                    data-cart-render="item_count">{{$countProdotti}}</span>
                            </a>
                            <!--Minicart Popup-->
                            <div id="header-cart" class="block block-cart">
                                <ul class="mini-products-list">
                                    ...
                                    <li class="item">
                                        <a class="product-image" href="/products/{{$prod->identificativo}}">
                                            <img class="imgCart" src="{{$prod->immagine}}"
                                                alt="Elastic Waist Dress - Black / Small" title="" />
                                        </a>
                                        <div class="product-details">
                                            <form class="deleteProductForm"
                                                action="/cart_products/{{$prod->identificativo}}" method="post">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <a class="pName" href="cart.html">{{$prod->nameProdotto}}</a>
                                            <div class="variant-cart">{{$prod->categoria}}</div>
                                            <div class="wrapQtyBtn">
                                                <div class="qtyField">
                                                    <span class="labe">Quantità:{{$prod->quantità}}</span>
                                                </div>
                                            </div><br>
                                            <div class="priceRow">
                                                <div class="product-price">
                                                    <span class="labe">Prezzo:{{$prod->prezzoProdotto}}€</span>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <div class="total">
                                    ...
                                    <div class="total-in">
                                        ...
                                        <span class="label">Cart Subtotal:</span><span class="product-price">
                                            ...
                                            <span class="money">Totale:{{$num->total}}€</span>
                                            @endforeach
                                            @endif
                                        </span>
                                        @else
                                        <span class="labe">Nessun elemento nel carrello</span>
                                        @endif
                                    </div>
                                    @if($countProdotti!=0)
                                    <div class="buttonSet text-center">
                                        <a href="/cart_products/{{$idCart}}"
                                            class="btn btn-secondary btn--medium">Mostra<br>
                                            carrello</a>
