...
<div id="page-content">
        ...
        <div class="collection-hero" style="backdrop-filter: blur(3px);">
            <div class="collection-hero__image">
                ...
                <div style="margin-top:1%">
                    <h1 style="margin-left:47%;color:black;" class="name">{{$info->nomeVenditore}}</h1>
                    <div style="margin-left:45%;color:black;" class="info">{{$info->emailVenditore}}</div>
                </div>
                @endforeach

                <div class="stats row" style="margin-left: 44%;">
                    <div class="stat col-xs-4">
                        <p class="number-stat" style="color:black;">{{$countReview}}</p>
                        <p class="desc-stat" style="margin-left:-20%;color:black;">Recenesioni</p>
                    </div>
                    <div class="stat col-xs-4" style="margin-left:2%">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="container2" style="padding-left:6%;">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="section-header text-center">
                            <h2 class="h2 heading-font">Recenesioni effettuate</h2>

                            <a href="/showAccount">Mostra tutte</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-12 col-md-9 col-lg-9 main-col" style="padding-left:26%;">
